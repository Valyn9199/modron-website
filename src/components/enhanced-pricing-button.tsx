    ...
    >
      <div className="flex items-center gap-3 text-gray-900">
        <div className="relative">
          <Icons.CreditCard className="w-5 h-5 text-gray-900 transition-transform duration-300 group-hover:scale-110" />
          {isHovered && (
            <div className="absolute inset-0 animate-ping">
              <Icons.CreditCard className="w-5 h-5 text-gray-900 opacity-30" />
            </div>
          )}
        </div>
