      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Australian-built, immersion-cooled GPU clusters (RTX PRO 6000, H200, L40S, Blackwell GB300) with industry-leading compute density for sovereign AI model training and enterprise-grade inference with complete data sovereignty",
            "provider": {
              "@type": "LocalBusiness",
              "name": "MODRON"
            },
    ...
    "additionalProperty": [
      {
        "@type": "PropertyValue",
        "name": "GPU Models",
        "value": "RTX PRO 6000, H200, L40S, Blackwell GB300"
      },
      {
        "@type": "PropertyValue",
