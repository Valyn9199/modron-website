  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center" role="group" aria-label="Call to action buttons">
      ...
      <LoadingButton 
        variant="outline" 
        size="lg" 
        className="text-body px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 border-2 border-gray-300 text-gray-400 hover:bg-gray-200 hover:border-primary-cyan hover:text-white transition-all duration-300 transform hover:scale-105"
